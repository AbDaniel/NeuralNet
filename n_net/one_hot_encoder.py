...
if __name__ == '__main__':
    ...
    for x in xrange(epoch):
        ...
        print(
            "{0} : CEE {1} : Number of correctly classisfied instances {2} : Number of Incorrectly classisfied instances {3}"
                .format(x, J, round(accuracy * training_data_size), training_data_size - round(accuracy * training_data_size)))
